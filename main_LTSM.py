...
if __name__ == "__main__":
    ...
    # model = LSTMModel(batch_size=batch_size).to(device)
    model = LSTMModel(input_size=1280, hidden_size=1280, n_layers=8, batch_size=batch_size, dropout=dropout).to(device)
